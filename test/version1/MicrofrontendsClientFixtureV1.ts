...
export class MicrofrontendsClientFixtureV1 {
    ...
    testCrudOperations(done) {
        ...
        // Create one microfrontend
            (callback) => {
                this._client.createMicrofrontend(
                    null,
                    MICROFRONTEND1,
                    (err, microfrontend) => {
                        assert.isNull(err);
        ...
        // Get all microfrontends
            (callback) => {
                this._client.getMicrofrontends(
                    null,
                    null,
        ...
        // Update the microfrontend
            (callback) => {
                ...
                this._client.updateMicrofrontend(
                    null,
                    microfrontend1,
                    (err, microfrontend) => {
                        assert.isNull(err);
        ...
        // Delete microfrontend
            (callback) => {
                this._client.deleteMicrofrontendById(
                    null,
                    microfrontend1.id,
                    (err) => {
                        assert.isNull(err);
        ...
        // Try to get delete microfrontend
            (callback) => {
                this._client.getMicrofrontendById(
                    null,
                    microfrontend1.id,
                    (err, microfrontend) => {
                        assert.isNull(err);
